...
var CartesianAxis = (_temp = _class = function (_Component) {
  ...
  _createClass(CartesianAxis, [{
    ...
    value: function getTicksStart(_ref2, preserveEnd) {
      ...
      var resultForSize = result.slice(0, count);
      var size = CartesianAxis.getMaxTickSize({ result: resultForSize, tickFormatter: tickFormatter, sizeKey: sizeKey });
    ...
    key: 'getMaxTickSize',
    value: function getMaxTickSize(_ref3) {
      var result = _ref3.result,
          tickFormatter = _ref3.tickFormatter,
          sizeKey = _ref3.sizeKey;

      return result.reduce(function (maxSize, entry) {
        var content = (0, _isFunction3.default)(tickFormatter) ? tickFormatter(entry.value) : entry.value;
        var tickSize = (0, _DOMUtils.getStringSize)(content)[sizeKey];
    ...
    value: function getTicksEnd(_ref4) {
      ...
      var resultForSize = result.slice(0, len - 1);
      var size = CartesianAxis.getMaxTickSize({ result: resultForSize, tickFormatter: tickFormatter, sizeKey: sizeKey });
